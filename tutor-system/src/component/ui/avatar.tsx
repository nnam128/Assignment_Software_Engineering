...
const AvatarFrame = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) =>(
    <div ref={ref} className={cn("w-10 h-10 overflow-hidden rounded-full border border-gradient-50 flex justify-center items-center shadow-2xl ", className)} {...props} />
));
...
const AvatarName = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) =>(
    <div ref={ref} className={cn("w-10 h-10 overflow-visible rounded-full border border-gradient-50 flex justify-center items-center shadow-2xl bg-primary text-white", className)} {...props} />
))
