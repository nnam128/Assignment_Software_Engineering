    ...
    if (user) {
      return (
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all text-black/80 hover:bg-white/10 hover:text-black"
        >
          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center backdrop-blur-sm">
                <img className="w-6 h-6 text-black" src='/logo-hcmut.png' />
              </div>
              <div>
                <h1 className="text-xl font-bold text-black">HCMUT Tutor</h1>
                <p className="text-xs text-black/80">Support System</p>
              </div>
            </Link>
